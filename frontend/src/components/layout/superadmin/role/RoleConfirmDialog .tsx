    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm rounded-2xl border border-white/[0.08] bg-[#161C3A] overflow-hidden">
        <div className="px-6 py-5 flex items-start gap-3">
          <span className="w-9 h-9 shrink-0 rounded-full bg-[#FF6B6B]/15 text-[#FF6B6B] flex items-center justify-center">
        ...
        <div className="flex items-center justify-end gap-2.5 px-6 py-4 border-t border-white/[0.08]">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={submitting}
            className="flex items-center gap-2 rounded-lg bg-[#FF6B6B] text-[#0B0F26] text-[13px] font-semibold px-4 py-2.5 hover:bg-[#FF6B6B]/90 transition-colors disabled:opacity-50"
          >
