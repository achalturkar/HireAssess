      ...
      <div className="w-full max-w-sm rounded-2xl border border-[var(--border)] bg-[var(--surface)] overflow-hidden">
        ...
        <div className="flex items-center justify-end gap-2.5 px-6 py-4 border-t border-[var(--border)]">
          <button
            ...
            onClick={onCancel}
            disabled={submitting}
            className="rounded-lg px-4 py-2.5 text-[13px] font-medium text-[var(--muted)] hover:bg-[var(--surface-muted)] transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            ...
            onClick={onConfirm}
            disabled={submitting}
            className={`flex items-center gap-2 rounded-lg text-[var(--primary-foreground)] text-[13px] font-semibold px-4 py-2.5 transition-colors disabled:opacity-50 ${
